...
<div class="login-card">
    ...
    <form action="proseslogin.php" method="POST">
        <div class="fgroup">
            ...
            <input type="email" class="finput" name="email" placeholder="Masukkan email Anda" value="<?= htmlspecialchars($_GET['email'] ?? '') ?>" required autofocus>
        </div>
        ...
        <div class="options-row">
            <label class="checkbox-label">
                <input type="checkbox" name="remember" <?= (isset($_GET['remember']) && $_GET['remember'] === 'true') ? 'checked' : '' ?>> Ingat Saya
            </label>
